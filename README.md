...
Runs configurable simulation iterations

Randomly assigns cities and job titles to applicants

Calculates frequencies for each city-job combination

Summarizes average counts across all simulations

Uses tidyverse for data manipulation and analysis
